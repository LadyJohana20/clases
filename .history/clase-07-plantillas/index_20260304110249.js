...
app.get("/", (req, res) => {
    res.render("home", { //renderizamos la plantilla home.hbs
      title: "Bienvenidos a mi sitio web", message: "Hola, esta es la plantilla de inicio"});//pasamos datos a la vista
});
